...
Below is an exported PDF of the dashboard. Viewers may download the original Power BI file (.pbix) attached to [this repository](StudentPerformancePortfolio.pbix) to interact with the dashboard for free using Power BI Desktop!
